...
public class ClientFormController extends Thread {
    public AnchorPane ctxClientForm;
    public Label lblClientName;
    public TextArea txtConversationArea;
    public TextField txtMsgToSendArea;
...
//======================================================================
    ...
    public void btnSendMsgOnAction(ActionEvent actionEvent) throws IOException {

        String msg = txtMsgToSendArea.getText();
        writer.println(lblClientName.getText() + ": " + msg);

        txtMsgToSendArea.clear();
    ...
    public void uploadImgMouseClicked(MouseEvent mouseEvent) {
